...
include_once('sql/pantallas.php') ?>
    ...
    <form role="form" method="POST" action="sql/agregar_ficha_medica1.php">
            ...
            $query = "SELECT id_ficha_medica,grado, nombre,apellido, ficha_medica.periodo_actualizacion,ficha_medica.tipo_sangre ,ficha_medica.enfermedad,ficha_medica.historia_enfermedad,ficha_medica.medicamentos,ficha_medica.nombre_medico,ficha_medica.telefono_medico, ficha_medica.otro,ficha_medica.telefono_otro FROM  ficha_medica INNER JOIN estudiante ON estudiante.`id_estudiante` = ficha_medica.id_estudiante WHERE estudiante.id_estudiante = $id_estudiante";
            $resultado = $conexion -> query($query);
         ...
         <th> <a href="sql/modificar_ficha_medica.php?id=<?php echo $id_estudiante; ?>&id1=<?php echo $row['id_ficha_medica']; ?>"> Modificar</a> 
